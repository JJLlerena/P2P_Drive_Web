...
function About() {
    return(
    <div className="About">
        <h1 class=' mt-24 pt-24 w-80 text-6xl text-center'> ABOUT US</h1>
          <h2 class='pt-5 text-center text-lg'>Here at FIU we are given the opportunity to work on new and exciting. 
