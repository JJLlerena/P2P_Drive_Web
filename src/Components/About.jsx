    ...
    return(
        ...
        <div className="About">
            ...
            <div class='grid bg-slate-200 pt-5 gap-y-4 grid-cols-2 h-fit w-96 px-10 mx-auto'>
                <div>
                <img class='h-10 w-10 rounded-full justify-self-center mx-10' src={Penguin} alt='Johhny'/>
                    <span>
                        Johnny Llerena
                    </span>
                    <br/>
                ...
                <div>
                <img class='h-10 w-10 rounded-full justify-self-center mx-10' src={Gerardo} alt='Gerardo'/>
                    <span>
                        Gerardo Leon
                    </span>
                    <br/>
                ...
                <div>
                <img class='h-10 w-10 rounded-full justify-self-center mx-10' src={Michael} alt='Michael'/>
                    <span>
                        Michael Garrido
                    </span>
                    <br/>
                ...
                <div>
                <img class='h-10 w-10 rounded-full justify-self-center mx-10' src={Patrick} alt='Martin'/>
                    <span>
                        Martin Moreano
                    </span>
                    <br/>
                ...
                <div>
                <img class='h-10 w-10 rounded-full justify-self-center mx-10' src={Squidward} alt='Shawn'/>
                    <span>
                        Shawn Zukowski
                    </span>
                    <br/>
                ...
                <div>
                <img class='h-10 w-10 rounded-full justify-self-center mx-10' src={Jorge} alt='Jorge'/>
                    <span>
                        Jorge Cortes
                    </span>
                    <br/>
                ...
                <div>
                <img class='h-10 w-10 rounded-full justify-self-center mx-10' src={DOM} alt='DOM'/>
                    <span>
                        Dominick Diaz
                    </span>
                    <br/>
